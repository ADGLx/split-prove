...
class _SkCommitPreimage_0 {
  alignment() {
    return _descriptor_0.alignment().concat(_descriptor_0.alignment().concat(_descriptor_0.alignment()));
  }
  fromValue(value_0) {
    return {
      sk_lo: _descriptor_0.fromValue(value_0),
      sk_hi: _descriptor_0.fromValue(value_0),
      r: _descriptor_0.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_0.toValue(value_0.sk_lo).concat(_descriptor_0.toValue(value_0.sk_hi).concat(_descriptor_0.toValue(value_0.r)));
  }
}

const _descriptor_1 = new _SkCommitPreimage_0();
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      bench_poseidon_commit: (...args_1) => {
        if (args_1.length !== 4) {
          throw new __compactRuntime.CompactError(`bench_poseidon_commit: expected 4 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('bench_poseidon_commit',
                                     'argument 1 (as invoked from Typescript)',
                                     'bench_poseidon_commit.compact line 17 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(sk_lo_0).concat(_descriptor_0.toValue(sk_hi_0).concat(_descriptor_0.toValue(r_0))),
        ...
        const result_0 = this._bench_poseidon_commit_0(context,
                                                       partialProofData,
                                                       sk_lo_0,
                                                       sk_hi_0,
                                                       r_0);
    ...
    this.impureCircuits = {
      bench_poseidon_commit: this.circuits.bench_poseidon_commit
    };
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('bench_poseidon_commit', new __compactRuntime.ContractOperation());
  ...
  _bench_poseidon_commit_0(context, partialProofData, sk_lo_0, sk_hi_0, r_0) {
    const tmp_0 = this._transientHash_0({ sk_lo: sk_lo_0, sk_hi: sk_hi_0, r: r_0 });
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
