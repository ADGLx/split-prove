...
const _descriptor_0 = new __compactRuntime.CompactTypeBytes(21);
...
const _descriptor_2 = new _ZswapCoinSecretKey_0();
...
class _PublicKeyPreimage_0 {
  ...
  fromValue(value_0) {
    return {
      ...
      secretKey: _descriptor_2.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_0.toValue(value_0.sep).concat(_descriptor_2.toValue(value_0.secretKey));
  }
}

const _descriptor_3 = new _PublicKeyPreimage_0();
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      bench_persistent_hash_sk: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`bench_persistent_hash_sk: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const sk_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('bench_persistent_hash_sk',
                                     'argument 1 (as invoked from Typescript)',
                                     'bench_persistent_hash_sk.compact line 18 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const result_0 = this._bench_persistent_hash_sk_0(context,
                                                          partialProofData,
                                                          sk_0);
    ...
    this.impureCircuits = {
      bench_persistent_hash_sk: this.circuits.bench_persistent_hash_sk
    };
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('bench_persistent_hash_sk', new __compactRuntime.ContractOperation());
  ...
  _bench_persistent_hash_sk_0(context, partialProofData, sk_0) {
    const tmp_0 = { bytes:
                      this._persistentHash_0({ sep:
