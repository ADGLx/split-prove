...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      bench_ec_mul_gen: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`bench_ec_mul_gen: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const scalar_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('bench_ec_mul_gen',
                                     'argument 1 (as invoked from Typescript)',
                                     'bench_ec_mul_gen.compact line 8 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(scalar_0),
        ...
        const result_0 = this._bench_ec_mul_gen_0(context,
                                                  partialProofData,
                                                  scalar_0);
    ...
    this.impureCircuits = { bench_ec_mul_gen: this.circuits.bench_ec_mul_gen };
    this.provableCircuits = {
      bench_ec_mul_gen: this.circuits.bench_ec_mul_gen
    };
  }
  initialState(...args_0) {
    if (args_0.length !== 1) {
    ...
    state_0.setOperation('bench_ec_mul_gen', new __compactRuntime.ContractOperation());
  ...
  _bench_ec_mul_gen_0(context, partialProofData, scalar_0) {
    const tmp_0 = this._ecMulGenerator_0(scalar_0);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
